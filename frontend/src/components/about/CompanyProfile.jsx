                    ...
                    <div className="lg:w-1/2">
                        <div>
                            ...
                            <motion.h2
                                ...
                                className="font-heading text-4xl lg:text-5xl font-bold text-primary mb-8 leading-tight"
                            >
                            ...
                            <motion.div
                                ...
                                className="prose prose-lg text-textSecondary space-y-6 mb-10"
                            >
                                <p>
                            ...
                            <motion.div
                                ...
                                className="border-t border-slate-200 pt-8 grid grid-cols-2 gap-8"
                            >
                                <div className="group">
                    ...
                    <div className="lg:w-1/2 relative">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                viewport={{ once: false, amount: 0.2 }}
                                transition={{ duration: 0.8, delay: 0.3 }}
                                className="absolute bottom-8 left-8 bg-white p-6 rounded-lg shadow-xl border border-slate-100 max-w-[240px] hidden md:block"
                            >
